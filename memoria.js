...
const imagens = ['./IMAGENS/aviao.jpg', './IMAGENS/catatau.jpg', 
'./IMAGENS/dora_1.jpg', './IMAGENS/galinha_pintadinha.jpg', './IMAGENS/marcha_1.jpg', 
'./IMAGENS/marcha_3.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../JOGO_MEMORIA_JOSE/id/${i}/100`);
 
let fundo = `./IMAGENS/capa_coelho_2.jpg`;
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogo
    ...
    document.querySelector('#btInicio').style.backgroundColor = '#2EFEF7';
    document.querySelector('#matematica').style.backgroundColor = '#2EFEF7';  
    document.body.style.backgroundImage = "url('./IMAGENS/Back_belisquim_1.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('#btInicio').style.backgroundColor = '#FF00BF';
    document.querySelector('.titulo').textContent ='Parabéns Belisquim!';
    document.querySelector('.titulo').style.backgroundColor ='#FF00BF';  
    document.querySelector('#matematica').style.backgroundColor = '#FF00BF';   
    document.body.style.backgroundImage = "url('./IMAGENS/Back_belisquim_Ceu.jpg')";
    timerDoJogo.stop(); 
}     
